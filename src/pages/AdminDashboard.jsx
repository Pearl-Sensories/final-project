...
function AdminDashboard() {
  return (
    <div>
         ...
         <h1 className='text-gray-500 text-3xl ml-60'>ADMIN DASHBOARD</h1>
         ...
         <button className='bg-red-700 text-white p-3 w-20 mt-5 rounded-xl'>Suspend</button>
         </span>
